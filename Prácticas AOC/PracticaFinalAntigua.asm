...
NumeroGrande:.asciiz "\nUno de los números introducidos no cabe en un registro de 32 bits\n"
...
.text
		...
		jal QuitaEspacios
		#Quitamos los - que vayan antes de un número y los sustituimos por
		#+, almacenando el número en negativo
...
QuitaMenos:	#Esta función recibe la dirección inicial de una cadena en
		...
		#los - que vayan seguidos de un número por el número opuesto
		#precedido de un +
		
		#En caso de que el - esté seguido de otro -, guarda 
		
		
BucleMenos:	#Cargo un byte de la cadena en $t0
		lb $t0,($a0)
		beq $t0,$zero,SalirMenos
		bne $t0, 32, SigueBucleM
		#Si es un espacio, aumenta el puntero en $a0
		addi $a0,$a0,1
		j BucleMenos
SigueBucleM:	#Guarda el byte leído en la cadena Final
		sb $t0,($a1)
		#Le suma 1 a la dirección de $a0 y $a1
		addi $a0, $a0, 1
		addi $a1, $a1, 1
