...
Longitud:	#Cargo un byte
		...
		#Ahora compruebo si es un dígito decimal, si no, salgo del bucle:
		slti $t2, $t6, 48
		...
		bne $t2, $zero, FinLongitud
		beq $t3, $zero, FinLongitud
...
Error:		#Pongo el error 2-carácter incorrecto en $v1 y salgo de la función:
		li $v1, 2
		jr $ra
